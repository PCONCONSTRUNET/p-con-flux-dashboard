              ...
              {!pixGenerated ? (
                <>
                  ...
                  <button
                    ...
                    disabled={processing}
                    className="w-full h-16 rounded-2xl font-display font-bold tracking-wide text-base transition-all disabled:opacity-50 flex items-center justify-center gap-2.5 text-white"
                    style={{
