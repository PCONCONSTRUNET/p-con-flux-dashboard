      ...
      <div className="flex flex-1">
        ...
        <main className="flex-1 p-4 lg:p-6 pb-20 lg:pb-6 overflow-auto relative">
          ...
          <div className="hidden lg:flex items-center justify-end mb-6">
            <div
              className="w-[280px] h-[150px] rounded-2xl flex flex-col justify-center relative cursor-pointer overflow-hidden transition-all duration-300 group"
              style={{
            ...
            >
              <p className="text-[50px] font-bold text-foreground leading-none ml-4 mt-0">
                {clock.slice(0, 5)}
                <span className="text-[15px] ml-1.5 text-foreground/70">{clock.slice(6)}</span>
              </p>
              <p className="text-lg font-medium text-foreground/80 ml-4 mt-1">
