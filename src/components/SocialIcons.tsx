const socials = [
  ...
  },
  {
    name: 'Discord',
    key: 'discord',
    link: 'https://discord.gg/jdWwBYqc4Z',
...
const SocialIcons = () => {
  return (
    <div className="flex items-center justify-center gap-3">
      {socials.map((s) => (
        <div key={s.key} className="social-icon-wrap group relative">
          {/* Tooltip */}
          <span
            className="social-tooltip"
            style={{ background: s.gradient, backgroundSize: '400% 400%', borderColor: s.color }}
          >
            {s.name}
          </span>
          {/* Icon button */}
